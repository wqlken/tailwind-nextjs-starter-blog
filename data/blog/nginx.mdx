...
![匹配结果](/static/images/Pasted%20image%2020220924110252.png)

**2. 以下三个匹配规则同时存在时的匹配结果：**

![](/static/images/Pasted%20image%2020220924111401.png)
![](/static/images/Pasted%20image%2020220924111435.png)
可以看出：正则匹配要大于通用匹配

**3. 多个正则匹配**

![](/static/images/Pasted%20image%2020220924111808.png)
![](/static/images/Pasted%20image%2020220924111856.png)
可以看出：多个正则匹配的时候，只匹配到第一个符合条件的正则；

**4. 添加精准匹配**

![](/static/images/Pasted%20image%2020220924112141.png)
![](/static/images/Pasted%20image%2020220924112248.png)
